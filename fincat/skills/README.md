...
This directory contains built-in skills that extend fincat's capabilities.
...
When skills reference large local documentation or logs, prefer fincat's built-in
