...
from fincat.config.loader import load_config, save_config
from fincat.security.network import validate_url_target
...
def test_onboard_does_not_crash_with_legacy_memory_window(tmp_path, monkeypatch) -> None:
    ...
    monkeypatch.setattr("fincat.config.loader.get_config_path", lambda: config_path)
    monkeypatch.setattr("fincat.cli.commands.get_workspace_path", lambda _workspace=None: workspace)
